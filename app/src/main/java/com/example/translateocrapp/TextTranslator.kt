...
class TextTranslator(private val context: Context) {
    ...
    fun translateOcrResult(ocrResult: Map<Rect, Text.TextBlock>, languageCode: String ): Map<Rect, String> {
        ...
        for ((rect, textBlock) in ocrResult) {
            ...
            // Append the translated text to the StringBuilder
            fullTranslatedText.append(translatedText).append(" ")

            // Add the translated text to the map
            translatedResult[rect] = translatedText
        }

// Log the entire translated text in one line
        //todo save this to room
        Log.d("TranslatedText", "Full Translated Text: $fullTranslatedText")
...
//    fun translatedText( languageText: StringBuilder ): StringBuilder {
//
//        return languageText
//    }
